...
namespace TerritoryTools.Web.MainSite.Services
{
    ...
    {
        List<PhoneTerritoryAssignment> GetAllAssignments();
        List<PhoneTerritoryAssignment> GetAssignments(string userName);
    }
    ...
    public class PhoneTerritoryAssignmentService : IPhoneTerritoryAssignmentService
    {
        ...
        private readonly ITerritoryUserService _territoryUserService;
        ...
        public List<PhoneTerritoryAssignment> GetAssignments(string userName)
        {
            var allAssignments = GetAllAssignments();
            var user = _territoryUserService.GetUserFrom(userName);

            return allAssignments
                .Where(a => string.Equals(a.Publisher, user.Name)
                    && a.Transaction == "Checked Out")
                .ToList();
        }

        public List<PhoneTerritoryAssignment> GetAllAssignments()
        {
