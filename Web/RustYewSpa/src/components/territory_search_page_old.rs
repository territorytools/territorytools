...
pub struct TerritorySearchPageOld {
    pub success: bool,
    pub count: i32,
...
#[function_component(TerritorySearchOld)]
pub fn address_search_page_old() -> Html {     
    ...
    let onchange = {
        ...
        Callback::from(move |event: Event| {
            ...
            let query = TerritorySearchQueryOld {
...
async fn get_territories(search_text: String) -> TerritorySearchPageOld {
    ...
    let result = TerritorySearchPageOld {
...
pub struct TerritorySearchQueryOld {
