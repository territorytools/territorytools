        ...
        <div class={"container"}>
            <form {onsubmit}>
                <div class={"form-group"}>
                    ...
                    // </div>
                    <BBButton label={"Completed"} class={"btn btn-primary"} data_test="submit" />
        ...
        <div class={"container"}>
            <div class={"row border-top py-2"}>
                <div class={"col-12"}>
                    ...
                    <span class={"alert alert-primary"}>{"Touch the icon after letter is sent"}<br/>{"发送信件后触摸图标"}</span>
                </div>
            </div>
            <div class={"row border-top py-2"}>
                <div class={"col-1"}>{"Status"}</div>
                <div class={"col-6"}>{"Name / Address"}</div>
            </div>
            <div class={"row border-top py-2"}>
                <div class={"col-1"}>
                    // <svg xmlns={"http://www.w3.org/2000/svg"} width={"48"} height={"48"} fill={"currentColor"} class={"bi bi-person-vcard"} viewBox={"0 0 16 16"}>
                ...
                <div class={"col-6"}>
                    <strong>{"Wang, Brian"}</strong>
                    <br/>
                    <span style={"width:10px;margin-top:0;"}>{"14815 Killroy Ave, Lynnwood, WA 98087"}</span>
                </div>
                <div class={"col-2"} >
            ...
            <div class={"row border-top py-2"}>
            <div class={"col-1"}>
                <svg xmlns={"http://www.w3.org/2000/svg"} width={"48"} height={"48"} fill={"currentColor"} class={"bi bi-envelope-open"} viewBox={"0 0 16 16"}>
                    <path d={"M8.47 1.318a1 1 0 0 0-.94 0l-6 3.2A1 1 0 0 0 1 5.4v.817l5.75 3.45L8 8.917l1.25.75L15 6.217V5.4a1 1 0 0 0-.53-.882l-6-3.2ZM15 7.383l-4.778 2.867L15 13.117V7.383Zm-.035 6.88L8 10.082l-6.965 4.18A1 1 0 0 0 2 15h12a1 1 0 0 0 .965-.738ZM1 13.116l4.778-2.867L1 7.383v5.734ZM7.059.435a2 2 0 0 1 1.882 0l6 3.2A2 2 0 0 1 16 5.4V14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V5.4a2 2 0 0 1 1.059-1.765l6-3.2Z"}/>
                </svg>
            </div>            
            <div class={"col-6"}>
                <strong>{"Wen, Doumi"}</strong>
                <br/>
                <span style={"width:10px;margin-top:0;"}>{"31434 Ash Way, #701-B Lynnwood, WA 98087"}</span>
            </div>
            <div class={"col-4"}></div>
            ...
            <div class={"row border-top py-2"}>
                <div class={"col-1 col-xs-3"}>
                    <svg xmlns={"http://www.w3.org/2000/svg"} width={"32"} height={"32"} fill={"currentColor"} class={"bi bi-envelope-check"} viewBox={"0 0 16 16"}>
                        ...
                        //<path style="transform: translate(6px,6px)" d="M6.75 1a.75.75 0 0 1 .75.75V8a.5.5 0 0 0 1 0V5.467l.086-.004c.317-.012.637-.008.816.027.134.027.294.096.448.182.077.042.15.147.15.314V8a.5.5 0 1 0 1 0V6.435a4.9 4.9 0 0 1 .106-.01c.316-.024.584-.01.708.04.118.046.3.207.486.43.081.096.15.19.2.259V8.5a.5.5 0 0 0 1 0v-1h.342a1 1 0 0 1 .995 1.1l-.271 2.715a2.5 2.5 0 0 1-.317.991l-1.395 2.442a.5.5 0 0 1-.434.252H6.035a.5.5 0 0 1-.416-.223l-1.433-2.15a1.5 1.5 0 0 1-.243-.666l-.345-3.105a.5.5 0 0 1 .399-.546L5 8.11V9a.5.5 0 0 0 1 0V1.75A.75.75 0 0 1 6.75 1zM8.5 4.466V1.75a1.75 1.75 0 1 0-3.5 0v5.34l-1.2.24a1.5 1.5 0 0 0-1.196 1.636l.345 3.106a2.5 2.5 0 0 0 .405 1.11l1.433 2.15A1.5 1.5 0 0 0 6.035 16h6.385a1.5 1.5 0 0 0 1.302-.756l1.395-2.441a3.5 3.5 0 0 0 .444-1.389l.271-2.715a2 2 0 0 0-1.99-2.199h-.581a5.114 5.114 0 0 0-.195-.248c-.191-.229-.51-.568-.88-.716-.364-.146-.846-.132-1.158-.108l-.132.012a1.26 1.26 0 0 0-.56-.642 2.632 2.632 0 0 0-.738-.288c-.31-.062-.739-.058-1.05-.046l-.048.002zm2.094 2.025z"/>

                    </svg><br/><span>{"01-26"}</span>
                </div>            
                <div class={"col-8 col-xs-9"}>
                    <strong>{"Qiao, Pingping"}</strong>
            ...
            <div class={"row border-top py-2"}>
                ...
                <div class={"col-xs-* col-md-* pl-1"}>
                    <strong>{"Bo, Aike"}</strong><span class={"badge bg-success ml-1 text-white"}>{"Sent: 2023-01-26"}</span>
                    <br/>
                    <span style={"width:10px;margin-top:0;"}>{"31434 Ash Way, #701-B Lynnwood, WA 98087"}</span>
                </div>
            </div>
            <div class={"row border-top py-2"}>
                ...
                <div class={"col-xs-6 col-md-8 pl-1"}>
                    <strong>{"Ou, Dixiong"}</strong><span class={"badge bg-success ml-1 text-white"}>{"Sent: 2023-01-26"}</span>
                    <br/>
            ...
            //     <div class={"col-4"}> <UserSelector onchange={assignee_onchange.clone()} /></div>
            // </div>
        </div>
        </>
    }
