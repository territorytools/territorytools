...
{
    //[TestFixture("123 Broadway Everett WA", "123", "", "Broadway", "", "Everett", "WA", "")]
    //[TestFixture("123 Main North Bend WA",  "123", "", "Broadway", "", "Everett", "WA", "")]
    //[TestFixture("123 Main South Bend WA", "123", "", "Broadway", "", "Everett", "WA", "")]
    //[TestFixture("POB 321", "321", "POB", "123", "", "Broadway", "", "Everett", "WA", "")]
    //[TestFixture("PO Box 321", "123", "", "Broadway", "", "Everett", "WA", "")]
    //[TestFixture("P O B 321", "123", "", "Broadway", "", "Everett", "WA", "")]
    //[TestFixture("P.O.Box 321", "123", "", "Broadway", "", "Everett", "WA", "")]
    //[TestFixture("P.O. Box 321", "123", "", "Broadway", "", "Everett", "WA", "")]
    //[TestFixture("P. O. B. 321", "123", "", "Broadway", "", "Everett", "WA", "")]
    //[TestFixture("P. O. Box 321", "123", "", "Broadway", "", "Everett", "WA", "")]
    //[TestFixture("Post Office Box 321", "123", "", "Broadway", "", "Everett", "WA", "")]
    [TestFixture("123 Main St", "123", "", "Main", "St", "", "Everett", "WA", "")]
    [TestFixture("123 Broadway Everett WA", "123", "", "Broadway", "", "", "Everett", "WA", "")]
    public class AddressParserTests
    {
        ...
        const string PREFIX_STREET_TYPES = "HWY:HIGHWAY,SR";

        //[Test]
        //public void Parse_City_Name()
        //{
        //    Assert.AreEqual(city, result.City.Name);
        //}

        [Test]
        public void Parse_Street_Number()
        {
            Assert.AreEqual(streetNumber, result.Street.Number);
        }

        [Test]
        public void Parse_Street_Name()
        {
            Assert.AreEqual(streetName, result.Street.Name.Name);
        }
