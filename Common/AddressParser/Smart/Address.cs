    ...
    public class Address
    {
        ...
        public bool SameAs(Address other)
        {
            return SameRequired(Street.Number, other.Street.Number)
                ...
                && (StreetType.SamePrefix(Street.Name.StreetTypePrefix, other.Street.Name.StreetTypePrefix)
                  && StreetType.SameSuffix(Street.Name.StreetType, other.Street.Name.StreetType))
