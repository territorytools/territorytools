...
{
    [Cmdlet(VerbsCommon.Get,"AlbaAssignment")]
    [OutputType(typeof(Assignment))]
    public class GetAlbaAssignment : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                var resultString = Connection
                    .DownloadString(RelativeUrlBuilder.GetAllTerritories());

                //var allTerritories = TerritoryResultParser.Parse(resultString);
